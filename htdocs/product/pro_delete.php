...
<body>
  ...
  <div class="container">
    <h3 class="text-cart my-5 d-flex justify-content-center">商品削除</h3>
    <div class="d-flex align-items-center justify-content-center">
      ...
      <p class="mt-3 text-center"> この商品を削除してもよろしいですか？ </p>
      <form class="my-5 d-flex justify-content-center " method="post" action="pro_delete_done.php">
        <input type="hidden" name="code" value="<?PHP print $pro_code; ?>">
        <input type="hidden" name="gazou_name" value="<?PHP print $pro_gazou_name; ?>">
        <input class="ml-3 d-grid btn btn-primary text-white" type="button" onclick="history.back()" value="戻る">
        <input class="ml-3 d-grid btn btn-primary text-white mx-2" type="submit" value="OK">
      </form>
